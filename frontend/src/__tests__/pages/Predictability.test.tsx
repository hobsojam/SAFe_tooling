...
const mockObjectives = [
  makePIObjective({ id: 'obj-1', team_id: 'team-1', pi_id: 'pi-1', planned_business_value: 8, actual_business_value: 7, is_stretch: false }),
  makePIObjective({ id: 'obj-2', team_id: 'team-1', pi_id: 'pi-1', planned_business_value: 5, actual_business_value: null, is_stretch: false }),
  makePIObjective({ id: 'obj-3', team_id: 'team-2', pi_id: 'pi-1', planned_business_value: 6, actual_business_value: 6, is_stretch: true }),
];
...
describe('Predictability', () => {
  ...
  it('shows "Not yet scored" for objectives without actual BV', () => {
    setupMocks({
      objectives: [
        makePIObjective({ team_id: 'team-1', planned_business_value: 8, actual_business_value: null, is_stretch: false }),
      ],
    });
    render(<Predictability />);
