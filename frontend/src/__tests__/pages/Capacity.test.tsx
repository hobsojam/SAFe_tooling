...
const mockIterations = [
  { id: 'iter-1', number: 1, start_date: '2026-01-05', end_date: '2026-01-16', is_ip: false, pi_id: 'pi-1' },
  { id: 'iter-2', number: 2, start_date: '2026-01-19', end_date: '2026-01-30', is_ip: false, pi_id: 'pi-1' },
];
const mockTeams = [
...
describe('Capacity color coding', () => {
  ...
  it('applies amber (yellow) classes when load is below 70%', () => {
    ...
    const planButton = buttons.find((b) => b.textContent?.includes('50') && b.textContent?.includes('days'));
