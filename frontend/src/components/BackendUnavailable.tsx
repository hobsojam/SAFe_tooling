  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="text-center max-w-md px-6">
        <h1 className="text-2xl font-semibold text-slate-800 mb-3">Backend is starting up…</h1>
        <p className="text-slate-500 mb-2">
          The server was sleeping and is waking up. This takes about 30 seconds on the free tier.
        </p>
        <p className="text-slate-400 text-sm mb-6">Retrying automatically in {countdown}s…</p>
        <button
          onClick={retryNow}
